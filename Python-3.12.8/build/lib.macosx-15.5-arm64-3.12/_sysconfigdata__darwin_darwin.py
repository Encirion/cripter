...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup '
              '-L/opt/homebrew/opt/tcl-tk@8.6/lib '
              '-L/opt/homebrew/opt/tcl-tk@8.6/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '.exe',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/opt/homebrew/opt/tcl-tk@8.6/include',
 'CONFIGURE_LDFLAGS': '-L/opt/homebrew/opt/tcl-tk@8.6/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--with-tcltk-includes=-I/opt/homebrew/opt/tcl-tk@8.6/include' "
                "'--with-tcltk-libs=-L/opt/homebrew/opt/tcl-tk@8.6/lib "
                "-ltcl8.6 -ltk8.6' "
                "'PKG_CONFIG_PATH=/opt/homebrew/opt/tcl-tk@8.6/lib/pkgconfig' "
                "'LDFLAGS=-L/opt/homebrew/opt/tcl-tk@8.6/lib' "
                "'CPPFLAGS=-I/opt/homebrew/opt/tcl-tk@8.6/include'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/stanislav/Documents/cripter/Python-3.12.8/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/Users/stanislav/Documents/cripter/Python-3.12.8/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.12 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/opt/homebrew/opt/tcl-tk@8.6/include '
             '-I/opt/homebrew/opt/tcl-tk@8.6/include',
 'CXX': 'g++',
 ...
 'MODULE__BLAKE2_CFLAGS': '-I/opt/local/include',
 ...
 'MODULE__BLAKE2_LDFLAGS': '-L/opt/local/lib -lb2',
 ...
 'MODULE__CURSES_CFLAGS': '-D_DARWIN_C_SOURCE -DNCURSES_WIDECHAR '
                          '-I/opt/local/include -D_XOPEN_SOURCE_EXTENDED=1',
 ...
 'MODULE__CURSES_PANEL_CFLAGS': '-D_DARWIN_C_SOURCE -DNCURSES_WIDECHAR '
                                ...
                                '-I/opt/local/include -D_DARWIN_C_SOURCE '
                                '-DNCURSES_WIDECHAR -I/opt/local/include '
                                '-D_XOPEN_SOURCE_EXTENDED=1',
 'MODULE__CURSES_PANEL_LDFLAGS': '-L/opt/local/lib -Wl,-search_paths_first '
                                 '-lpanel -L/opt/local/lib '
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                   ...
                   '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                   '-I/opt/homebrew/opt/tcl-tk@8.6/include '
                   '-I/opt/homebrew/opt/tcl-tk@8.6/include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/opt/homebrew/opt/tcl-tk@8.6/lib '
                    '-L/opt/homebrew/opt/tcl-tk@8.6/lib',
 'PY_CPPFLAGS': '-I. -I./Include -I/opt/homebrew/opt/tcl-tk@8.6/include '
                '-I/opt/homebrew/opt/tcl-tk@8.6/include',
 'PY_ENABLE_SHARED': 0,
 'PY_HAVE_PERF_TRAMPOLINE': 0,
 'PY_LDFLAGS': '-L/opt/homebrew/opt/tcl-tk@8.6/lib '
               '-L/opt/homebrew/opt/tcl-tk@8.6/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/opt/homebrew/opt/tcl-tk@8.6/lib '
                     '-L/opt/homebrew/opt/tcl-tk@8.6/lib',
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare '
                        ...
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include -I/opt/homebrew/opt/tcl-tk@8.6/include '
                        '-I/opt/homebrew/opt/tcl-tk@8.6/include',
 'PY_SUPPORT_TIER': 2,
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 ...
 'abs_builddir': '/Users/stanislav/Documents/cripter/Python-3.12.8',
 'abs_srcdir': '/Users/stanislav/Documents/cripter/Python-3.12.8',
